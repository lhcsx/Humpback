...
Humpback::Canvas::Canvas(int widht, int height)
{
	mWidth = widht;
	mHeight = height;
...
void Humpback::Canvas::ResetCanvas(const Color& color)
{
...
void Humpback::Canvas::WriteColor(int x, int y, const Color& c)
{
	if (x < 0 || y < 0)
	{
		return;
...
void Humpback::Canvas::Canvas2PPM()
{
	/*
		P3
		width height
